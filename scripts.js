...
function changeColour(theColour) {
	theElement.style.background = theColour;
}
...
square.addEventListener('mouseenter', (event) => changeColour('gray'));
square.addEventListener('mousexit', (event) => changeColour('red'));
square.addEventListener('click', (event) => onClicked());
